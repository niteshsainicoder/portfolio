...
function NavBAR() {
  ...
  const navitem = ["Home", "Properties", "My Bookings", "favorites"]
  useEffect(() => {
    if (mobilemenu) {
  ...
  return (
    <div className="w-full relative h-20 z-10   flex border-b border-white   text-grey-100 ">
      ...
      <div className="w-6/12 sm:hidden  flex items-end justify-end">
        ...
        <div className={`w-full transition-all ease-in-out delay-200 z-50   h-52 bg-neutral-200 rounded-lg  absolute -left-96 ${mobilemenu ? "  flex  flex-col justify-evenly items-center left-0 top-24" : "hidden"}`}>
